...
@section('content')
    ...
    <div class="content-container">
        <div class="table-responsive">
            ...
            <button type="button" class="btn btn-primary position-relative m-2" data-bs-toggle="modal"
                data-bs-target="#failuresModal">
                View Failures
            ...
            <!-- Modal -->
            <div class="modal modal-lg fade" id="failuresModal" tabindex="-1" role="dialog"
                aria-labelledby="failuresModalLabel" aria-hidden="true">
    ...
    <script>
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            } else if (account.type == 'SA') {
                                newRow.append($('<td>').text('Super Admin'));
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '#type', function() {
                ...
                if (selectedType === 'AD' || selectedType === 'SA') {
                    $('#department').prop('disabled', true).val('');
                } else {
                    $('#department').prop('disabled', false);
                }
